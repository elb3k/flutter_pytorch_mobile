...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
    ...
    switch(method) {
        ...
        case 2:
        {
            ...
            try {
                auto output  = [imageModule predictImage:input withWidth:width andHeight: height];
        ...
        case 3:
        {
            ...
            try {
                auto output  = [d2Module detectron2:input withWidth:width withHeight: height withMinScore: minScore];
